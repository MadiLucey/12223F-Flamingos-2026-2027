...
motor LinearLiftMotorA = motor(PORT6, ratio18_1, false);
motor LinearLiftMotorB = motor(PORT7, ratio18_1, false);
motor_group LinearLift = motor_group(LinearLiftMotorA, LinearLiftMotorB);
...
void autonomous(void) {
  ...
  arm.spinFor(forward, 0.5, turns, false);
  Claw.spin(forward);
}
